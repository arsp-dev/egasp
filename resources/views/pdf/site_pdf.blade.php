            ...
            <div class="small" style="position: absolute; top:0px; left: 800px; font-size: 10px;">
              ...
              <span><b>REV. # 0</b></span><br>
               ...
               <table class="table table-condensed table-bordered small" style="font-size: 9px;">
                 ...
                 {{-- <table class="table table-condensed table-bordered small text-center" style="font-size: 8px;">
                  <thead>
                    
                  <tr>
                      <th colspan="17">Date of Susceptibility Testing (Sentinel Site): {{ $isolate->site_isolate->date_of_susceptibility }}</th>
                      <th colspan="16">Date of Susceptibility Testing (ARSP Lab): {{ $isolate->lab_isolate->date_of_susceptibility }}</th>
                  </tr>
                    <tr>
                      <td> </td>
                      <td>AZM (Disk)</td>
                 ...
                 <table  class="table table-condensed table-bordered small text-center" style="border: none; font-size: 9px">
                  <tr>
