...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('laboratory_isolates', function (Blueprint $table) {
            ...
            $table->text('azm_mic_operand')->nullable();
            ...
            $table->text('spt_mic_operand')->nullable();
            ...
            $table->text('tcy_mic_operand')->nullable();
